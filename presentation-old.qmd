...
## [Objectives]{style="color:#C2DB70"} {.center}
...
## <code><span style="color:#4C5455">Data Visualization - the Big Picture</span></code>

### A broad picture of data visualization {.center}
...
<div style="text-align:center">
<iframe width="560" height="355" src="https://www.youtube-nocookie.com/embed/bHrf_FDf39Q?si=Q6XNOmyS-KtYuJ1u" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" referrerpolicy="strict-origin-when-cross-origin" allowfullscreen></iframe>
</div>

## <code><span style="color:#4C5455">Case 12d - Sports Analytics</span></code>

<iframe src="curry_3pt_threejs_sequential_unmirrored.html" width="100%" height="420px"></iframe>
